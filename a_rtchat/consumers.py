...
class ChatroomConsumer(WebsocketConsumer):
    def connect(self):
        self.user=self.scope['user'] #because we dont have request object anymore
    ...
    def receive(self, text_data):#in json format, convert to python format
    ...
    def message_handler(self, event):
        ...
        #render_to_string in consumers.py similar to return in views.py
